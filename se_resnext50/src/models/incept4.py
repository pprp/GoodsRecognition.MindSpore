...
class Inceptionv4(nn.Cell):
    ...
    """
    def __init__(self, in_channels=3, num_classes=1000, k=192, l=224, m=256, n=384, is_train=True):
        ...
        self.softmax = nn.DenseBnAct(
            1536, num_classes, weight_init="XavierUniform", has_bias=True, has_bn=True, activation="logsoftmax")
        if is_train:
...
def inceptionv4(num_classes=2388):
    return Inceptionv4(3, num_classes=num_classes)