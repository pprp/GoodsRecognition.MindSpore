...
def resnext50(num_classes=2388):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes, width_per_group=4, groups=7, use_se=False)

def resnext101(num_classes=2388):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes, width_per_group=8, groups=7, use_se=False)