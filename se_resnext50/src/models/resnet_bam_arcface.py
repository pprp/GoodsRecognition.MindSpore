...
class ResNet(nn.Cell):
    ...
    def __init__(self, block, layers, network_type, num_classes, att_type=None):
        ...
        #     has_bias=True,
        #     weight_init=_fc(512 * block.expansion, num_classes),
        #     bias_init=0,
        # )
...
def resnet50_bam_arcface(num_classes=2388):
    '''2048 dimension'''
    return ResidualNet("ImageNet", depth=50, num_classes=num_classes, att_type="BAM")


def resnet50_cbam_arcface(num_classes=2388):
    return ResidualNet("ImageNet", depth=50, num_classes=num_classes, att_type="CBAM")
