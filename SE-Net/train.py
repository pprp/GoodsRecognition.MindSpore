...
parser.add_argument('--net', type=str, default="se-resnet50", help='Resnet Model, either resnet50 or resnet101')
parser.add_argument('--dataset', type=str, default="RP2K", help='Dataset, either cifar10 or imagenet2012')
